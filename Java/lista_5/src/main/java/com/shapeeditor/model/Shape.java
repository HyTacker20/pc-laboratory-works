...
public abstract class Shape {
    ...
    /**
     * Sets the rotation angle of the shape directly to the specified angle in degrees.
     *
     * @param angleDegrees The absolute angle to set, in degrees
     */
    public void setRotation(double angleDegrees) {
        this.rotation = angleDegrees % 360;
        if (this.rotation < 0) {
            this.rotation += 360;
        }
    }
